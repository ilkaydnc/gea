...
`<Outlet />` renders the matched route component with full lifecycle — `created()`, events, child components all work normally. It updates automatically when the user navigates.
